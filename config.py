...
LLM_USER_PROMPT: Final = os.getenv("LLM_USER_PROMPT") or (
    ...
    "2. Data da compra (formato DD-MM-YYYY).\n\n"
     ...
     "forem 'CIMAEER', 'COMERCIO', 'DE', 'M' seguidas de "
     "CNPJ, o nome é 'CIMAFER COMERCIO DE M' (ou "
     "'CIMAFER COMÉRCIO DE MATERIAIS').\n"
     ...
     "   - Se houver endereço no texto (linhas com 'Rua', 'Av', "
     "'Avenida', 'Praça'), use-o como contexto para corrigir "
     "o nome do estabelecimento — por exemplo, se o nome "
     "estiver distorcido e o endereço apontar para um local "
     "conhecido, ajuste o nome para o mais provável.\n"
     "   - Da mesma forma, use a cidade (se disponível no "
     "comprovante) como contexto para identificar o "
